...
export default function Home() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center py-20 px-4 relative overflow-hidden">
            ...
            {/* HEADER */}
            <section className="text-center mb-16 relative z-10 max-w-4xl mx-auto fade-up">
                <h1 className="text-7xl md:text-9xl font-black tracking-tighter text-white mb-6" style={{ textShadow: '0 0 30px rgba(255,255,255,0.3)' }}>
                    SYMLAB
                </h1>
