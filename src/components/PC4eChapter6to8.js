    ...
    return (
        <group>
            ...
            <Html transform={false}>
                <DraggableHtmlPanel usePortal={false} title="💡 Sources de Lumière" showCloseButton={false} defaultPosition="bottom-center" className="w-[300px] border-yellow-500/30 text-white">
...
export function Chap7PropagationLumiere() {
    ...
    return (
        <group>
            ...
            <Html transform={false}>
                <DraggableHtmlPanel usePortal={false} title="🌑 Ombres & Propagation" showCloseButton={false} defaultPosition="bottom-center" className="w-[300px] border-white/30 text-white">
                    <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-2">
                        <div className="flex gap-2">
...
export function Chap8Refraction() {
    ...
    return (
        <group>
            <Html transform={false}>
                <DraggableHtmlPanel usePortal={false} title="🌈 Réfraction (Snell-Descartes)" showCloseButton={false} defaultPosition="bottom-center" className="w-[320px] border-cyan-500/30 text-white">
                    <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-2">
                        <div className="flex gap-2">
