    ...
    return (
        <group>
            ...
            <Html transform={false}>
                <DraggableHtmlPanel title="📍 Cinématique">
...
export function DynamiqueNewton() {
    ...
    return (
        <group>
            ...
            <Html transform={false}>
                <DraggableHtmlPanel title="⚖️ Dynamique - Newton">
...
export function ProjectileMotion() {
    ...
    return (
        <group>
            ...
            <Html transform={false}>
                <DraggableHtmlPanel title="🎯 Mouvement Projectile">
                    <div className="text-white min-w-[200px]">
...
export function GravitationSatellite() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🌍 Gravitation">
        <div className="text-white min-w-[200px]">
...
export function ChampMagnetiqueSolenoid() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🧲 Champ Magnétique">
        <div className="text-white min-w-[200px]">
...
export function ForceLorentz() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="⚡ Force de Lorentz">
        <div className="text-white min-w-[200px]">
...
export function LoiLaplace() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🔌 Loi de Laplace">
        <div className="text-white min-w-[200px]">
            <label className="block text-sm">Courant I = {current} A</label>
            <input type="range" min="0" max="10" value={current}
                onChange={e => setCurrent(Number(e.target.value))}
...
export function InductionRL() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🔋 Dipôle RL">
        <div className="text-white min-w-[200px]">
...
export function DipoleRC() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🔋 Dipôle RC">
        <div className="text-white min-w-[200px]">
...
export function OscillationsLCRLC() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="📡 Oscillations LC/RLC">
        <div className="text-white min-w-[200px]">
            <div className="flex gap-2 mb-3">
...
export function OscillationsMecaniques() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="⏱️ Oscillations Mécaniques">
        <div className="text-white min-w-[200px]">
            <div className="flex gap-2 mb-3">
...
export function InterferencesYoung() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🌈 Interférences">
        <div className="text-white min-w-[200px]">
...
export function EffetPhotoelectrique() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="💡 Effet Photoélectrique">
        <div className="text-white min-w-[200px]">
...
export function NiveauxEnergie() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="🔬 Niveaux d'Énergie">
        <div className="text-white min-w-[200px]">
...
export function ReactionsNucleaires() {
    ...
    return (<group><Html transform={false}><DraggableHtmlPanel title="☢️ Réactions Nucléaires">
        <div className="text-white min-w-[200px]">
            <div className="flex gap-2 mb-3">
