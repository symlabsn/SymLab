    ...
    chapters: [
        {
            ...
            content: `
                <h3>1. Structure</h3>
                <p>Noyau, Cytoplasme, Membrane. Distinction Animale/Végétale.</p>
                <h3>2. Unicellulaires</h3>
                <p>Bactéries et Protozoaires.</p>
            `,
        ...
        },
        {
            ...
            content: `
                <h3>1. Bactéries</h3>
                <p>Micro-organismes procaryotes utiles (yogourt) ou pathogènes (choléra).</p>
                <h3>2. Virus</h3>
                <p>Parasites intracellulaires obligatoires (Grippe, SIDA).</p>
            `,
        ...
        },
        {
            ...
            content: `
                <h3>1. Echanges d'eau (Osmose)</h3>
                <p>L'eau suit le sel.</p>
                <h3>2. Echanges de solutés</h3>
                <p>Diffusion du plus concentré vers le moins concentré.</p>
            `,
        ...
        },
        {
            ...
            content: `
                <h3>1. Du Gène à la Protéine</h3>
                <p>L'information génétique (ADN) est copiée (Transcription) puis lue (Traduction) pour fabriquer des protéines.</p>
            `,
            summary: ["ADN -> ARN -> Protéine."],
        ...
        },
        {
            ...
            content: `
                <h3>1. Mitose</h3>
                <p>Division conforme. Une cellule donne deux identiques.</p>
                <h3>2. Chromosomes</h3>
                <p>Visibles pendant la division. Support des caractères héréditaires.</p>
            `,
        ...
        },
        {
            ...
            content: `
                <h3>1. Les Aliments</h3>
                <p>Glucides, Lipides, Protides, Eau, Vitamines.</p>
                <h3>2. Digestion</h3>
                <p>Simplification moléculaire par les enzymes digestives (salive, suc gastrique...).</p>
            `,
        ...
        },
        {
            ...
            content: `
                <h3>1. La villosité intestinale</h3>
                <p>Surface d'échange immense dans l'intestin grêle.</p>
                <h3>2. Voies d'absorption</h3>
                <p>Voie sanguine (Sucres, acides aminés) et voie lymphatique (Graisses).</p>
            `,
        ...
        },
        {
            ...
            content: `
                <h3>1. Roches</h3>
                <p>Sédimentaires (Calcaire), Magmatiques (Basalte), Métamorphiques.</p>
                <h3>2. Phénomènes</h3>
                <p>Érosion, sédimentation, volcanisme.</p>
            `,
        ...
        },
        {
            ...
            story: "Nos richesses.",
            content: `
                <h3>1. Potentialités</h3>
                <p>Phosphates, Fer, Or, Ciment (Calcaire), Sel.</p>
                <h3>2. Importance économique</h3>
                <p>Exploitation industrielle (ICS, Dangote, Sabodala).</p>
            `,
