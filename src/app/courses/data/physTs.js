export const physTsData = {
    ...
    chapters: [
        ...
        // ==========================================
        {
            ...
            simulation: { id: 'pts-cinematique', title: 'Cinématique : La Danse des Courbes' },
...
- **Mouvement Circulaire Uniforme** : Accélération normale centripète $a_n = \\frac{v^2}{R}$.
        ...
        },
        {
            ...
            simulation: { id: 'pts-dynamique', title: 'Lois de Newton : Maître des Forces' },
...
Le mouvement du centre d'inertie G d'un système est déterminé par la somme des forces extérieures appliquées.
        ...
        },
        {
            ...
            simulation: { id: 'pts-applications', title: 'Tir de Précision : Trajectoire Parabolique' },
...
$\\Delta E_c = \\sum W(\\vec{F})$. Variation d'énergie cinétique = Somme des travaux des forces.
        ...
        },
        {
            ...
            simulation: { id: 'pts-gravitation', title: 'Orbite Spatiale : Danse des Planètes' },
...
- 3. $\\frac{T^2}{r^3} = \\text{constante}$.
        ...
        // ==========================================
        {
            ...
            simulation: { id: 'pts-champ-magnetique', title: 'Lignes de Champ : Le Flux Invisible' },
...
Le champ total est la somme vectorielle des champs créés par chaque source.
        ...
        },
        {
            ...
            simulation: { id: 'pts-lorentz', title: 'Accélérateur de Particules : Lorentz' },
...
Dans un champ uniforme, le mouvement est **circulaire uniforme**. Le rayon $R = \\frac{mv}{|q|B}$.
        ...
        },
        {
            ...
            simulation: { id: 'pts-laplace', title: 'Moteur Électrique : Force de Laplace' },
...
- **Rails de Laplace :** Tige mobile sur deux rails dans un champ B.
        ...
        },
        {
            ...
            simulation: { id: 'pts-induction', title: 'Induction Magnétique : Le Courant Fantôme' },
...
Constante de temps $\\tau = \\frac{L}{R}$.
        ...
        },
        {
            ...
            simulation: { id: 'pts-rc', title: 'Chronomètre Électronique : Dipôle RC' },
...
$E_C = \\frac{1}{2} C u_C^2$.
        ...
        // ==========================================
        {
            ...
            simulation: { id: 'pts-oscillations-lc', title: 'Résonance Magnétique : Circuit RLC' },
...
Un générateur impose sa fréquence. Phénomène de **Résonance** quand la fréquence excitatrice est proche de la fréquence propre. (Ex: Circuit de syntonisation radio).
        ...
        },
        {
            ...
            simulation: { id: 'pts-oscillations-meca', title: 'Pendule Hypnotique : Oscillations' },
...
- Pendule : $E_p = mgh$.
        ...
        },
        {
            ...
            simulation: { id: 'pts-interferences', title: "Franges de Lumière : L'Expérience d'Young" },
...
$i = \\frac{\\lambda D}{a}$ (D=distance écran, a=écart fentes).
        ...
        // ==========================================
        {
            ...
            simulation: { id: 'pts-photoelectrique', title: 'Photon Impact : L\'Effet Photoélectrique' },
...
- $E_c$ : Énergie cinétique du reste.
        ...
        },
        {
            ...
            simulation: { id: 'pts-niveaux-energie', title: 'Saut Quantique : Spectres Atomiques' },
...
Signature unique de chaque élément chimique. Série de Balmer (Visible pour l'Hydrogène).
        ...
        },
        {
            ...
            simulation: { id: 'pts-nucleaire', title: 'Réacteur Nucléaire : Fission & Fusion' },
