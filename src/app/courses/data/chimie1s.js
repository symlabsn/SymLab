export const chimie1sData = {
    ...
    chapters: [
        ...
        // ==========================================
        {
            ...
            simulation: { id: 'c1s-general', title: 'Architecture du Vivant : Le Carbone' },
...
Des isomères ont la même formule brute mais des formules développées différentes (donc des propriétés différentes).
        ...
        },
        {
            ...
            simulation: { id: 'c1s-alcanes', title: 'Énergie Fossile : Les Alcanes' },
...
**Halogénation (Substitution) :** Réaction avec $Cl_2$ ou $Br_2$ à la lumière (photochimique).
        ...
        },
        {
            ...
            simulation: { id: 'c1s-alcenes', title: "L'Insaturation : La Double Liaison" },
...
L'acétylène ($C_2H_2$) est utilisé pour la soudure (flamme très chaude).
        ...
        },
        {
            ...
            part: 'Chimie Organique',
            title: 'C4. Le Benzène',
            simulation: { id: 'c1s-benzene', title: 'Le Cercle Parfait : L\'Aromaticité' },
...
- Sulfonation.
        ...
        },
        {
            ...
            simulation: { id: 'c1s-oxygenes', title: 'Chimie des Parfums : Les Oxygénés' },
...
Tests : DNPH (précipité jaune pour les deux), Liqueur de Fehling (rouge brique pour Aldéhydes seulement).
        ...
        // ==========================================
        {
            ...
            simulation: { id: 'c1s-redox', title: 'Duel d\'Électrons : Oxydant vs Réducteur' },
...
À l'équivalence : $\\frac{n(Ox_1)}{a} = \\frac{n(Red_2)}{b}$.
        ...
        },
        {
            ...
            simulation: { id: 'c1s-electrolyse', title: 'Électrolyse : Forcer le Destin Chimique' },
...
Nombre de moles d'électrons : $n(e^-) = \\frac{Q}{F}$ avec $F \\approx 96500 C/mol$.
        ...
        },
        {
            ...
            simulation: { id: 'c1s-voieseche', title: 'Forge Chimique : La Voie Sèche' },
